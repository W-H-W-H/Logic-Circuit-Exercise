...
function checkGameStatus(){
  ...
  if (isCompleted == true) {
    submit_Button.innerText = "Success! Next Question";
...
function setup() {
  ...
  if (Stage < ProblemSet.length) {
    document.querySelector("#MessageBox").innerText = ProblemSet[Stage].Message;
    load_setting(Stage);
  } else {
    ArrayOfIn = [];
    ArrayOfOut = [];
  ...
  submit_Button.innerText = "Give Up. Next Question";
