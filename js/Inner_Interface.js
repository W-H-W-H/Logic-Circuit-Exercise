...
function connect_Element(stack) {
    ...
    if(order1 < order2 || (order1 == 2 && order1 == order2) ){
        ...
        if(arg1.getNumOfIn()==1){
            ...
            thisIndex = prompt(`Please select which input (0 to n-1) of ${arg1.getLabel()} you would like to be connected`);
        ...
        if(arg2.getNumOfOut()==1){
            ...
            parentIndex = prompt(`Please select which output (0 to n-1) of ${arg2.getLabel()} you would like to be connected`);
